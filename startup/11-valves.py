...
valve_APPES_open = EpicsSignal('XF:23ID2-VA{IOXAS-GV:5}Cmd:Opn-Cmd', name='appes_open')
valve_APPES_close = EpicsSignal('XF:23ID2-VA{IOXAS-GV:5}Cmd:Cls-Cmd', name='appes_close')
